...
//variable for sounds
var coinsound,gameoversound,destroySound;
...
function setup(){
    ...
    start.setCollider('circle',0,0,90)
    ...
    option.setCollider('rectangle',0,0,300,100)
    ...
    howPlay.setCollider('rectangle',-20,-60,440,100);
